...
These offsets are relative to the **Stats Sub-structure** which is located at `[GameObject + 0x49E8]`
...
| **mSpellBlock** | `0x180` | `0x4B68` | Magic Resist (ai generated)|
...
| **TargetNetID** | `0x4C` | `DWORD` | Network ID of the target unit (if targeted) |
...
| Field | Offset | Type | Description |
| :--- | :--- | :--- | :--- |
| **NetworkID** | `0x10` | `DWORD` | Unique global ID for the object |
