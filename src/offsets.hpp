...
namespace Offsets {
    constexpr uintptr_t ImageBase = 0x7FF7E6500000;
    ...
    namespace Globals {
        ...
        constexpr uintptr_t r3dRenderer = 0x1F7CD18;
    }

    namespace Functions {
        constexpr uintptr_t BuffManagerClient__OnBuffRemove = 0x920260;
        constexpr uintptr_t CanCast = 0x2C4F90;
        constexpr uintptr_t CastSpellPosition = 0x97A8C0;
        constexpr uintptr_t CastSpellTarget = 0x979FF0;
        constexpr uintptr_t CastSpellWrapper = 0x2045D0;
        constexpr uintptr_t CharacterDataStack__Push = 0x3F21C0;
        constexpr uintptr_t CharacterDataStack__Update = 0x3F3060;
        constexpr uintptr_t ComponentLookupFn = 0x11AA3A0;
        constexpr uintptr_t ComponentRegistry__Lookup = 0x11AA3A0;
        ...
        constexpr uintptr_t GetAttackDelay = 0x573480;
        constexpr uintptr_t GetAttackWindup = 0x573380;
        constexpr uintptr_t GetBoundingRadius = 0x278010;
        constexpr uintptr_t GetCollisionFlags = 0x126A090;
        constexpr uintptr_t GetFirstObject = 0x552CB0;
        constexpr uintptr_t GetMapID = 0x27E660;
        constexpr uintptr_t GetModelInstance = 0x295080;
        constexpr uintptr_t GetNextObject = 0x553B20;
        constexpr uintptr_t GetPing = 0x6CC760;
        constexpr uintptr_t GetSpellCastInfo = 0x659310;
        constexpr uintptr_t GetSpellSlot = 0x969280;
        constexpr uintptr_t GetSubObjAiMgr = 0x53DA40;
        constexpr uintptr_t IsAlive = 0x2B0B00;
        constexpr uintptr_t IsBuilding = 0x2C5330;
        constexpr uintptr_t IsHero = 0x2C5180;
        constexpr uintptr_t IsTurret = 0x2C5080;
        constexpr uintptr_t IsVisible = 0x211CA0;
        constexpr uintptr_t IssueOrderCore = 0x2899D0;
        constexpr uintptr_t MinimapHudInit = 0x922120;
        constexpr uintptr_t MinimapMoveSelf = 0x599840;
        constexpr uintptr_t NavAgent = 0x58EDB0;
        constexpr uintptr_t NavMesh__CreatePath = 0x2309B0;
        constexpr uintptr_t OnCreateObject = 0x55D750;
        constexpr uintptr_t OnDeleteObject = 0x562CD0;
        constexpr uintptr_t OnDoCast = 0x97B210;
        constexpr uintptr_t OnProcessSpell = 0x981B90;
        constexpr uintptr_t OnSpellImpact = 0x979580;
        constexpr uintptr_t PrintChat = 0x114EB40;
        constexpr uintptr_t ProjectAndClip = 0x1316000;
        constexpr uintptr_t QuestProgress__Calculate = 0x522300;
        constexpr uintptr_t QuestProgress__GetQuestValue = 0x526450;
        constexpr uintptr_t QuestProgressFn = 0x522300;
        constexpr uintptr_t QuestValueFn = 0x526450;
        constexpr uintptr_t RemapBoneIndex = 0x2CAEE0;
        constexpr uintptr_t RoleBound__Init = 0x111E550;
        constexpr uintptr_t RoleBoundInit = 0x111E550;
        constexpr uintptr_t SpellSlot__Cast = 0x755390;
        constexpr uintptr_t SpellSlot__GetCooldown = 0x912E30;
        constexpr uintptr_t SpellSlot__GetLevel = 0x3A8A7B;
        constexpr uintptr_t TransformVec3 = 0x1318040;
        constexpr uintptr_t UpdateCamera = 0x2F88C0;
        constexpr uintptr_t WaypointCount = 0x398B0;
        constexpr uintptr_t WorldToScreen = 0x13160E0;
        constexpr uintptr_t fieldOfView = 0x749940;
    }
