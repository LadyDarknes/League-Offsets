...
namespace Offsets {
    constexpr uintptr_t ImageBase = 0X7FF7EBAA0000;

    namespace Globals {
        constexpr uintptr_t LocalPlayer = 0X1F695D0;
        constexpr uintptr_t HeroManager = 0X1F25E88;
        constexpr uintptr_t MinionManager = 0X1F458E0;
        constexpr uintptr_t BlueMinionManager = 0X1F29218;
        constexpr uintptr_t RedMinionManager = 0X1F29220;
        constexpr uintptr_t TurretManager = 0X1F25E90;
        constexpr uintptr_t ViewPort = 0X1F29260;
        constexpr uintptr_t MouseScreenVec2 = 0X1F25D68;
        constexpr uintptr_t UnderMouseObj = 0X1F294B8;
        constexpr uintptr_t ObjectManager = 0X1F25D68;
        constexpr uintptr_t GameTime = 0X1F36120;
        constexpr uintptr_t MissileManager = 0X1F29208;
        constexpr uintptr_t MissileContainer = 0X1F5DA18;
        constexpr uintptr_t HudInstance = 0X1F25EF8;
        constexpr uintptr_t ChatManager = 0X1F393C8;
        constexpr uintptr_t ChatClient = 0X1F64760;
        constexpr uintptr_t NavGrid = 0X1F291F8;
        constexpr uintptr_t NetClient = 0X1F25D60;
        constexpr uintptr_t NetInstance = 0X1F25D78;
        constexpr uintptr_t EntityList = 0X1F25F10;
        constexpr uintptr_t GameClient = 0X1F41200;
        constexpr uintptr_t SpellCastMap = 0X1F20F48;
        constexpr uintptr_t SwapChain = 0X1FC9710;
        constexpr uintptr_t TimingTable = 0X1F217F8;
        constexpr uintptr_t ZoomAnomalyLatch = 0X1E8AAF0;
        constexpr uintptr_t r3dRenderLayer = 0X2008A78;
        constexpr uintptr_t r3dRenderer = 0X2008A70;
        constexpr uintptr_t g_thread_device = 0X2008A98;
        constexpr uintptr_t g_current_x3d_device_override = 0X2008A98;
        constexpr uintptr_t g_x3d_d3d11_backend = 0X2008A98;
        constexpr uintptr_t g_d3dcompiler47_module = 0X2009258;
        constexpr uintptr_t g_D3DReflect = 0X1F20F48;
        constexpr uintptr_t ViewMatrixInstance = 0XE540;
        constexpr uintptr_t X3DDeviceD3D11_vtable = 0X1B817F8;
        constexpr uintptr_t CastSpellFlag = 0X1F2C2A3;
        constexpr uintptr_t IssueOrderFlag = 0X1E8AF18;
        constexpr uintptr_t ConnSlotSentinel = 0X1F6B064;
    }

    namespace Functions {
        constexpr uintptr_t BuffManagerClient__OnBuffRemove = 0X8C3000;
        constexpr uintptr_t CanCast = 0X2E1320;
        constexpr uintptr_t CastSpellPosition = 0XC67970;
        constexpr uintptr_t CastSpellSafe = 0XBDC990;
        constexpr uintptr_t CastSpellTarget = 0X553B40;
        constexpr uintptr_t CastSpellWrapper = 0X20B6E0;
        constexpr uintptr_t CharacterDataStack__Push = 0X4098E0;
        constexpr uintptr_t CharacterDataStack__Update = 0X24A990;
        constexpr uintptr_t CharacterDataStackPush = 0X296E60;
        constexpr uintptr_t CharacterDataStackUpdate = 0X218490;
        constexpr uintptr_t ComponentLookupFn = 0X11BF700;
        constexpr uintptr_t ComponentRegistry__Lookup = 0X2174D0;
        constexpr uintptr_t CurrentNodeIdx = 0X4A317;
        constexpr uintptr_t DistanceSq = 0X221E20;
        constexpr uintptr_t GameObject__IsType = 0X29B640;
        constexpr uintptr_t GetAIManager = 0X289C10;
        constexpr uintptr_t GetAttackDelay = 0X29FFF0;
        constexpr uintptr_t GetAttackWindup = 0X58E660;
        constexpr uintptr_t GetBoundingRadius = 0X289050;
        constexpr uintptr_t GetCollisionFlags = 0X1281DA0;
        constexpr uintptr_t GetFirstObject = 0X57F6F0;
        constexpr uintptr_t GetGoldRedirectTarget = 0X210CD0;
        constexpr uintptr_t GetMapID = 0X17F5660;
        constexpr uintptr_t GetModelInstance = 0X2AC2A0;
        constexpr uintptr_t GetNextObject = 0X580040;
        constexpr uintptr_t GetObjectByID = 0X57F020;
        constexpr uintptr_t GetPing = 0X6D9920;
        constexpr uintptr_t GetRenderPipeline = 0X4A8540;
        constexpr uintptr_t GetSpellCastInfo = 0X66FC40;
        constexpr uintptr_t GetSpellSlot = 0X9988F0;
        constexpr uintptr_t GetSubObjAiMgr = 0X581F70;
        constexpr uintptr_t IsAlive = 0X2CABD0;
        constexpr uintptr_t IsBuilding = 0XE19300;
        constexpr uintptr_t IsHero = 0XC75850;
        constexpr uintptr_t IsTurret = 0X2E1410;
        constexpr uintptr_t IsVisible = 0X219280;
        constexpr uintptr_t IssueOrderCore = 0X20B330;
        constexpr uintptr_t MinimapHudInit = 0XC40CD0;
        constexpr uintptr_t MinimapMoveSelf = 0XC68FC0;
        constexpr uintptr_t NavAgent = 0X5B6A70;
        constexpr uintptr_t NavMesh__CreatePath = 0X20F4C0;
        constexpr uintptr_t OnCreateObject = 0X2BCE20;
        constexpr uintptr_t OnDeleteObject = 0X57E440;
        constexpr uintptr_t OnDoCast = 0X97A3C0;
        constexpr uintptr_t OnNewPath = 0X58CEC0;
        constexpr uintptr_t OnProcessSpell = 0X97F3A0;
        constexpr uintptr_t OnSpellImpact = 0X99E7C0;
        constexpr uintptr_t PrintChat = 0X11629E0;
        constexpr uintptr_t ProjectAndClip = 0X1361FE0;
        constexpr uintptr_t QuestProgress__Calculate = 0X3C3300;
        constexpr uintptr_t QuestProgress__GetQuestValue = 0X247B50;
        constexpr uintptr_t RemapBoneIndex = 0X71A4B0;
        constexpr uintptr_t RoleBound__Init = 0XA1580;
        constexpr uintptr_t SpellSlot__Cast = 0X766D90;
        constexpr uintptr_t SpellSlot__GetCooldown = 0X9649F0;
        constexpr uintptr_t SpellSlot__GetLevel = 0X3C0CAB;
        constexpr uintptr_t TransformVec3 = 0X1364020;
        constexpr uintptr_t TranslateString = 0X11BEDF0;
        constexpr uintptr_t UpdateCamera = 0X306E40;
        constexpr uintptr_t WaypointCount = 0X2749D0;
        constexpr uintptr_t WorldToScreen = 0X13620C0;
        constexpr uintptr_t fieldOfView = 0X4063E0;
        constexpr uintptr_t ClientMainLoop = 0X1666D90;
        constexpr uintptr_t OnWndProc = 0X120C880;
        constexpr uintptr_t OnStopCast = 0X654F30;
        constexpr uintptr_t OnPlayAnimation = 0X2AC2A0;
        constexpr uintptr_t BuffManagerClient__OnBuffAdd = 0X8C24F0;
        constexpr uintptr_t IssueOrderPacketWrapper = 0X20B6E0;
        constexpr uintptr_t GetThreadDevice = 0X21F770;
        constexpr uintptr_t X3DDeviceD3D11_Initialize = 0X1FD470;
        constexpr uintptr_t X3DDeviceD3D11_Release = 0X211280;
        constexpr uintptr_t ConstantBuffer_CreateD3D11DynamicBuffer = 0X32B5D0;
        constexpr uintptr_t D3D11TextureView_CreateShaderResourceView = 0X29D790;
        constexpr uintptr_t DX11Backend_CreateDeviceAndSwapChain = 0X20F4C0;
        constexpr uintptr_t GraphicsPipelineD3D11_InitFromDesc = 0XB9AA40;
        constexpr uintptr_t X3DDeviceD3D11_SetGraphicsPipeline = 0X380C20;
        constexpr uintptr_t X3DDeviceD3D11_CreateGraphicsPipeline = 0X3FC280;
        constexpr uintptr_t X3DDeviceD3D11_CreateVertexBuffer = 0X1F0010;
        constexpr uintptr_t X3DDeviceD3D11_CreateIndexBuffer = 0X1F0010;
        constexpr uintptr_t X3DDeviceD3D11_CreateDataBuffer = 0X21F770;
        constexpr uintptr_t X3DDeviceD3D11_CreateTexture2D = 0X117AF70;
        constexpr uintptr_t X3DDeviceD3D11_CreateVertexProgram = 0X1F0010;
        constexpr uintptr_t X3DDeviceD3D11_CreatePixelProgram = 0X1F0010;
        constexpr uintptr_t X3DDeviceD3D11_CreateShaderProgram = 0X1F0010;
        constexpr uintptr_t X3DDeviceD3D11_ClearFramebuffer = 0X13DBC20;
        constexpr uintptr_t X3DDeviceD3D11_BeginFrame = 0X1E9650;
        constexpr uintptr_t X3DDeviceD3D11_EndFrame = 0X1E9650;
        constexpr uintptr_t X3DDeviceD3D11_BeginRenderPass = 0X2085B0;
        constexpr uintptr_t X3DDeviceD3D11_EndRenderPass = 0X1E9650;
        constexpr uintptr_t X3DDeviceD3D11_IsRenderPassActive = 0X289E00;
        constexpr uintptr_t X3DDeviceD3D11_IsFrameActive = 0X289E00;
        constexpr uintptr_t X3DDeviceD3D11_Draw = 0X1F3690;
        constexpr uintptr_t X3DDeviceD3D11_DrawIndexed = 0X1F3690;
        constexpr uintptr_t g_thread_device = 0X21C160;
        constexpr uintptr_t g_x3d_d3d11_backend = 0X3972F0;
    }
    ...
    namespace Standard {
        namespace GameObject {
            ...
            constexpr uintptr_t oItemList = 0X44A8;
            ...
            constexpr uintptr_t Armor = 0X4DE8;
            ...
            constexpr uintptr_t TargetableFlags = 0XD0;
            ...
            constexpr uintptr_t IsTargetableToTeamFlags = 0XD0;
            ...
            constexpr uintptr_t oBuffManager = 0X27C8;
            constexpr uintptr_t oBuffManagerAlt = 0X2E58;
            constexpr uintptr_t oParticleName = 0X4598;
        ...
        namespace AIBaseClient {
            constexpr uintptr_t oCombatStats = 0X4440;
            constexpr uintptr_t oModelInstance = 0X44F0;
            constexpr uintptr_t oCharacterDataStack = 0X40F0;
            constexpr uintptr_t oBuffManager = 0X2D88;
            constexpr uintptr_t oFacing = 0X1C0;
            constexpr uintptr_t oPetOwner = 0X4D38;
            constexpr uintptr_t oHeroInventoryClient = 0X2C0;
            constexpr uintptr_t SkinId = 0X1314;
            constexpr uintptr_t CharacterData = 0X40F0;
        ...
        namespace CombatStats {
            ...
            constexpr uintptr_t mBonusArmor = 0X25C;
        ...
        namespace MissileClient {
            ...
            constexpr uintptr_t SpellName = 0X120;
        ...
        namespace AIManager {
            ...
            constexpr uintptr_t ServerPos = 0X560;
            ...
            constexpr uintptr_t Component = 0X4050;
        ...
        namespace SpellDataResource {
            ...
            constexpr uintptr_t BaseCost = 0X6D0;
            constexpr uintptr_t CastRadius = 0X7AC;
        ...
        namespace Navigation {
            constexpr uintptr_t XorKeyTable = 0X4248;
            constexpr uintptr_t EncryptedWrapper = 0X4250;
            constexpr uintptr_t ActiveSlotIndex = 0X4273;
            constexpr uintptr_t WrapperToPC = 0X10;
            constexpr uintptr_t ServerPos = 0X338;
            constexpr uintptr_t CurrentWaypoint = 0X354;
            constexpr uintptr_t WaypointArray = 0X348;
            constexpr uintptr_t WaypointCount = 0X350;
            constexpr uintptr_t EndPos = 0X598;
        }
        namespace StdString {
