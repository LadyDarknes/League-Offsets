...
namespace Offsets {
    ...
    namespace Globals {
        ...
        constexpr uintptr_t MinionManager = 0X1F25EC8;
        ...
        constexpr uintptr_t MouseScreenVec2 = 0X1F29268;
        ...
        constexpr uintptr_t ViewMatrixInstance = 0X1F29260;
    ...
    namespace Standard {
        namespace GameObject {
            ...
            constexpr uintptr_t Armor = 0X500;
        ...
        namespace CombatStats {
            constexpr uintptr_t mFlatAPMod = 0X208;
