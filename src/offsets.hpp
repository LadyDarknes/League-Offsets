...
namespace Offsets {
    ...
    namespace Standard {
        namespace GameObject {
            ...
            constexpr uintptr_t oSourceNetworkId = 0X1;
            constexpr uintptr_t oDead = 0X560;
            constexpr uintptr_t oEffectEmitterHandle = 0X1;
            ...
            constexpr uintptr_t oMissileClientHandle = 0X1;
            constexpr uintptr_t oTargetableComponent = 0X1;
            ...
            constexpr uintptr_t oRadius = 0X1;
        ...
        namespace AIBaseClient {
            ...
            constexpr uintptr_t BuffManager = 0XD8;
        ...
        namespace CombatStats {
            ...
            constexpr uintptr_t mBonusSpellBlock = 0X25C;
